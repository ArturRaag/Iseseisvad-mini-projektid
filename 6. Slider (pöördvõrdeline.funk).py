# -*- coding: utf-8 -*-
"""
Created on Mon Feb  1 08:34:08 2021
...
ax.set_title("Funktsiooni y=a/x+b graafik")
...
ax.set_yticks(np.arange(min(funktsioon),max(funktsioon),50))
ax.grid(True)

# Loome ka funktsiooni teksti mida graafikule display'ida.
graafiline_text=("y="+str(tous)+"/x"+"+"+str(vabaliige))
tekst_joonisel=ax.text(3,-100, graafiline_text, fontsize=14)
